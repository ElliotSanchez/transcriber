...
class TranscriptionsTableViewController: UITableViewController {
    ...
    */
    ...
    func checkPermissions() {
        let recAuthorized: Bool = AVAudioSession.sharedInstance().recordPermission() == .granted
        let speechAuthorized: Bool =  SFSpeechRecognizer.authorizationStatus() == .authorized
        let authorized = recAuthorized && speechAuthorized
